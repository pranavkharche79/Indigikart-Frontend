                ...
                <div className="col-sm-6 mx-auto">
                    ...
                    <div className="form-group form-row">
                        ...
                        <div className="col-sm-8">
                            <input type="text"  pattern="[A-Za-z ]+" title="Only Alphabet input is allowed" required placeholder="Enter the Customer Name" name="name" value={user.name} onChange={handleInput} className="form-control" />
                    ...
                    <div className="form-group form-row">
                        ...
                        <div className="col-sm-8">
                            <input type="text"  pattern="[A-Za-z]+"  title="Only Alphabet input is allowed"  placeholder="Enter the City" name="city" value={user.city} onChange={handleInput} className="form-control" />
                    ...
                    <div className="form-group form-row">
                        ...
                        <div className="col-sm-8">
                            <select name="gender" value={user.gender} required onChange={handleInput} className="form-control">
                    ...
                    <div className="form-group form-row">
                     ...
                     required value={user.phone} onChange={handleInput} className="form-control" />
