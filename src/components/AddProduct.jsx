                        ...
                        <div className="col-sm-6 mx-auto">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="text" required placeholder="Enter the Product Name" name="pname" value={product.pname} onChange={handleInput} className="form-control" />
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <button onClick={submitImage} required class="btn btn-success" >Upload Photo</button>
                                </div>
                            </div>
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <select name="category" required value={product.category} onChange={handleInput} className="form-control">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="number"  min="1" step="1" required placeholder="Enter the Price" name="price" value={product.price} onChange={handleInput} className="form-control" />
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input name="descr" maxLength={250} title="Max 250 Characters allowed" required placeholder="Enter Description" value={product.descr} onChange={handleInput} className="form-control"/>  
