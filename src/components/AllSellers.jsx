...
function AllSellers() {
  ...
  const loaddata = () => {
    axios
      .get("https://indigikart-backend-production.up.railway.app/api/sellers")
      .then((resp) => {
  ...
  const updateStatus = (seller) => {
    let response = window.confirm(
      "Are you sure to update this supplier status ?"
    );
    if (response) {
      axios
        .post(
          "https://indigikart-backend-production.up.railway.app/api/sellers/status",
          {
            sellerid: seller.id,
