            ...
            <form onSubmit={handleSubmit} >           
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="text" name="city" pattern="[A-Za-z]+"  title="Only Alphabet input is allowed" required placeholder="Enter the City" value={address.city} onChange={handleAddressInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-4 form-control-label">State</label>
                    <div className="col-sm-8">
                        <input type="text" name="state" pattern="[A-Za-z]+"  title="Only Alphabet input is allowed" required placeholder="Enter the State" value={address.state} onChange={handleAddressInput} className="form-control" />
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-4 form-control-label">Pin Code</label>
                    <div className="col-sm-8">
                        <input type="text"  pattern="[0-9]+" minLength={6} maxLength={6} placeholder="Enter 6 digit Pin Code" title="Only numerical values allowed of 6 digits" required name="zip" value={address.zip} onChange={handleAddressInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="text" pattern="[0-9]+" minLength={16} maxLength={16} placeholder="Enter 16 digit No." title="Only numerical value allowed of 16 digits" name="cardno" value={payment.cardno} onChange={handlePaymentInput} className="form-control"/>                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-4 form-control-label">Name on Card</label>
                    <div className="col-sm-8">
                        <input type="text" pattern="[A-Za-z ]+" title="Only Alphabet input is allowed" required placeholder="Enter Name on Card" name="nameoncard" value={payment.nameoncard} onChange={handlePaymentInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
      ...
      />
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                     ...
                     title="Only numerical value allowed of 3 digits" name="cvv" required value={payment.cvv} onChange={handlePaymentInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
