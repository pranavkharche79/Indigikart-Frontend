                        ...
                        <div className="col-sm-9">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="text"  required name="pname" value={product?.pname} onChange={handleInput} className="form-control" />
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <select name="category"  required value={product?.category.id} onChange={handleInput} className="form-control">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="number" min="1" step="1" required name="price" value={product?.price} onChange={handleInput} className="form-control" />
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="text" name="descr" maxLength={250} title="Max 250 Characters allowed" required placeholder="Enter Description" value={product?.descr} onChange={handleInput} className="form-control" />
