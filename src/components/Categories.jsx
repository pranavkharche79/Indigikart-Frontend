            ...
            <div className="row">
                ...
                <div className="col-sm-4">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" pattern="[A-Za-z ]+" title="Only Alphabet input is allowed" required placeholder="Enter the Category Name" onChange={handleCategoryNameChange} value={catname} className="form-control" />
                    </div>                   
                    <button onClick={handleSubmit} className="btn btn-primary float-right">Add</button>
                    </form>
                </div>
            </div>
        </div>
